...
function App() {
  ...
  const API_URL = process.env.REACT_APP_API_URL || '/security-scanner/api';
              ...
              {scanStatus === 'running' ? (
                ...
                <>
                  ...
                  <div style={styles.summaryGrid}>
                    ...
                    <div style={{...styles.summaryCard, borderTopColor: '#ffffffff'}}>
                      <div style={{...styles.summaryCount, color: '#ffffffff'}}>
                        {findings.length}
                      </div>
